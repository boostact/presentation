  ...
  return (
    <div>
      ...
      <div className={classes.bodyContainer}>
        <img className={classes.jjal} src="https://user-images.githubusercontent.com/33454557/102366718-524cb780-3ffc-11eb-84af-46f32d8b22cf.png"></img>
        <div>
          <ol className={classes.textContainer}>
            ...
            <li className={classes.textContent}>가상 DOM의 Diff 알고리즘 최적화</li>
            <li className={classes.textContent}>Key Attrivute</li>
          </ol>
        </div>
      </div>
    </div>
